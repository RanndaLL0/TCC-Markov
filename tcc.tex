...
\begin{table}[htb]
    ...
    \small
        ...
        \toprule
        \textbf{Critério} & \textbf{Araújo e Barbosa (2024)} & \textbf{Trabalho 2} & \textbf{Trabalho 3} & \textbf{Este trabalho} \\
        \midrule
        ...
        \addlinespace
        Granularidade & 1 hora & [gran.] & [gran.] & 5 minutos \\
        \addlinespace
        Modelagem & (\textit{Less-than-k-Markov}) & [modelo] & [modelo] & Cadeias de Markov de alta ordem (MTD/Raftery) e HMM \\
        \addlinespace
