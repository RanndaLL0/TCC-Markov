...
A metodologia para a seleção bibliográfica deste estudo baseou-se em buscas sistemáticas nas 
bases de dados \textit{ACM Digital Library}, \textit{IEEE Xplore} e \textit{Science Direct}. 
O processo foi estruturado em duas frentes estratégicas de investigação principais:
...
O modelo proposto por \citeonline{RAFTERY1985}, reduz a complexidade para $O(mn^2+m)$, para um modelo de cinco símbolos e 
cadeia de ordem $6$ teríamos $6\cdot5^2+6=156$, uma redução significativa de probabilidades de transição.
